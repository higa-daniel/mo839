"""
Iris Client with Byzantine attack simulation
"""
import random
import time
import hashlib
...
class ByzantineClient:
    """
        ...
        Each client open a gRPC channel and an IrisStub to connect to the server.
    """
    ...
    def __init__(self, client_id, attack_type=None, attack_strength=0.3):
        ...
        # Using the client_id as the random seed ensures that a client receives a
        # unique data split every time the code is executed
    ...
    def _client_id_to_seed(self, client_id):
        ...
        return int(hash_obj.hexdigest()[:8], 16) % 10000  # Limit the number

    def apply_attack(self, features, labels):
        """
            Apply 3 different types of Byzantine attacks
        """
